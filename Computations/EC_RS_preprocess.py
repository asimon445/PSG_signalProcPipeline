...
OUTPATH = '/Users/ajsimon/Dropbox (Personal)/Data/Overnight PSG/data/Resting/preprocessed/EC_1p5_stdev_new/'
...
thresh = 1.5   #this is the z-score value that we are using to detect artifacts. 
...
art_outfile = open(OUTPATH + 'artifact_rejection_info_1_point_5.csv','w')
with art_outfile:
...
#save failures
fails_outfile = open(OUTPATH + 'failures_info_1_point_5.csv','w')
with fails_outfile:
